...
class EvaluatorForm(forms.Form):
    ...
    weekly_showers = forms.IntegerField(label='On average, how many showers do you take in a week? ', 
                                                    required=True)

    shower_times = forms.IntegerField(label='On average, how long are your showers? (in minutes) ', 
                                                    required=True)

    weekly_baths = forms.IntegerField(label='On average, how many baths do you take in a week? ', 
                                                    required=True)
